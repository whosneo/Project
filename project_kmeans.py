...
def init_centroids(init_data_set, init_k):
    num_samples, dim = init_data_set.shape
...
# k-means cluster
def k_means(cluster_data_set, k):
    num_samples = cluster_data_set.shape[0]
    ...
    cluster_centroids = init_centroids(cluster_data_set, k)
...
def show_cluster(show_data_set, show_k, show_centroids, show_cluster_assment):
    num_samples = show_data_set.shape[0]
